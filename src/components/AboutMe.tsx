            ...
            <div className="space-y-4">
              ...
              <div className="relative border-l-2 border-slate-200 dark:border-white/10 ml-3.5 pl-5.5 space-y-6">
                {education.map((edu, i) => (
                  ...
                  >
                    {/* Ring Indicator */}
                    <span className="absolute -left-[30px] top-1.5 w-4 h-4 rounded-full bg-white dark:bg-black border-2 border-blue-600 dark:border-blue-500 group-hover:scale-125 transition-transform duration-200 shadow-md shadow-blue-500/20"></span>
                    <span className="text-xs font-mono font-bold text-blue-600 dark:text-blue-500 font-semibold tracking-wide">
                      {edu.period}
                    </span>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-1 gap-4">
                {strengths.map((str, i) => (
                  ...
                  >
                    <div className="p-2 rounded-lg bg-blue-500/10 border border-blue-500/20 shrink-0 self-start">
                      {str.icon}
                    </div>
                    <div>
